...
function setup() {
  ...
  ground = new Ground (300, 300, 900, 10);
...
function draw() {
  ...
  if(block1||block2||block3||block4||block5||block6||block7||block8||block9||block10.isTouching(monster)){
     monster.hide();
  }
  if(block11||block12||block13||block14||block15||block16||block17||block18||block19||block20.isTouching(monster)){
     monster.hide();
  }
  if(block21||block22||block23||block24||block25||block26||block27.isTouching(monster)){
    monster.hide();
 }
